...
export default class Server {
        ...
        return new Promise(function (fulfill, reject) {
            try {
                ...
                that.rest.get('/', function (req: restify.Request, res: restify.Response, next: restify.Next) {
                    let file = fs.readFileSync("./src/rest/view/index.html");
                    res.write(file);
                    res.end();
                    return next();
                });
    ...
    public static addDataset(req: restify.Request, res: restify.Response, next: restify.Next) {
        ...
        Server.insightFacade.addDataset(req.params.id, dataStr).then (function (result: InsightResponse) {
            res.json(result.code, result.body);
    ...
    public static removeDataset(req: restify.Request, res: restify.Response, next: restify.Next) {
        ...
        Server.insightFacade.removeDataset(req.params.id).then (function (result: InsightResponse) {
            res.json(result.code, result.body);
        }).catch(function (result: InsightResponse) {
            res.json(result.code, result.body);
        });
    ...
    public static performQuery(req: restify.Request, res: restify.Response, next: restify.Next) {
        ...
        Server.insightFacade.performQuery(req.body).then(function(result:InsightResponse){
