...
describe("InsightFacedeTestSpec", function () {
    ...
    var content, norealdata, xyz, rooms;
    before(function () {
    ...
    it("Add with no real data (400)", function () {
        return insightFacade.addDataset('courses', norealdata).then(function (val) {
            chai_1.expect.fail();
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'zip does not contain any real data.' });
        });
    });
    it("Remove", function () {
    ...
    it("Add not exist (400)", function () {
        return insightFacade.addDataset('courses', './haha.zip').then(function (val) {
            chai_1.expect.fail();
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'no such zip file exists.' });
        });
    });
    it("Remove with no file exists", function () {
        return insightFacade.removeDataset('yes').then(function (val) {
            chai_1.expect.fail();
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
            chai_1.expect(err.code).to.equal(404);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'the operation was unsuccessful because the delete was for a resource that was not previously added.' });
        });
    });
    it("Query 2 - complex", function () {
        ...
        return insightFacade.performQuery(query2)
            ...
            chai_1.expect(query.body).to.deep.equal(result2);
        }).catch(function (err) {
            console.log(err.toString());
            Util_1.default.test('Error: ' + err.toString());
            chai_1.expect.fail();
        });
    });
    it("Query 1 - simply", function () {
        return insightFacade.performQuery(query1)
            .then(function (query) {
            chai_1.expect(query.code).to.equal(200);
            chai_1.expect(query.body).to.deep.equal(result1);
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
            chai_1.expect.fail();
        });
    ...
    it("Query 2 - complex", function () {
        this.timeout(10000);
        return insightFacade.performQuery(query2).then(function (query) {
            chai_1.expect(query.code).to.equal(200);
            chai_1.expect(query.body).to.deep.equal(result2);
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
    ...
    it("Course avg for a course", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(query.code).to.equal(200);
            chai_1.expect(query.body).to.deep.equal({ render: 'TABLE', result: [{ courses_avg: 82.93 }] });
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
            chai_1.expect.fail();
        });
    ...
    it("Invalid query", function () {
        return insightFacade.performQuery(invalidQuery).then(function (query) {
            chai_1.expect.fail();
        }).catch(function (err) {
            Util_1.default.test('Error: ' + err);
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'the query failed because it does not contain proper form of query.' });
        });
    });
    it("Empty AND", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'Error: AND is empty' });
        });
    });
    it("Empty OR", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'Error: OR is empty' });
        });
    });
    it("Order not in columns", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'COLUMNS array does not contain the key in ORDER.' });
        });
    });
    ...
    it("Missing FORM", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'invalid FORM — missing FORM or FORM is not TABLE.' });
        });
    });
    ...
    it("EQ is not number", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'Error: EQ input is not a number.' });
        });
    });
    it("GT is not number", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'Error: GT input is not a number.' });
        });
    });
    it("LT is not number", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: 'Error: LT input is not a number.' });
        });
    });
    it("424 - one in COLUMNS", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.body).to.deep.equal({ missing: ['student'] });
        });
    });
    it("424 - ont in WHERE, one in COLUMN", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(424);
            chai_1.expect(err.body).to.have.property('missing');
            chai_1.expect(err.body).to.deep.equal({ missing: ['cour', 'instructor'] });
        });
    });
    it("424 - three in COLUMN", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(424);
            chai_1.expect(err.body).to.have.property('missing');
            chai_1.expect(err.body).to.deep.equal({ missing: ['school', 'ubc', 'student'] });
        });
    });
    ...
    it("424 - one in LT", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(424);
            chai_1.expect(err.body).to.have.property('missing');
            chai_1.expect(err.body).to.deep.equal({ missing: ['students'] });
        });
    });
    ...
    it("Invalid key in EQ", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: "Error: the key is not a valid key" });
        });
    });
    ...
    it("# Equal != 1", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: "Error: the number of object in EQ is not 1" });
        });
    });
    it("# GT != 1", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: "Error: the number of object in GT is not 1" });
        });
    });
    it("# LT != 1", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: "Error: the number of object in LT is not 1" });
        });
    });
    it("# IS != 1", function () {
        return insightFacade.performQuery({
            ...
            chai_1.expect(err.code).to.equal(400);
            chai_1.expect(err.body).to.have.property('error');
            chai_1.expect(err.body).to.deep.equal({ error: "Error: the number of object in IS is not 1" });
        });
    });
});
//# sourceMappingURL=InsightFacedeTestSpec.js.map